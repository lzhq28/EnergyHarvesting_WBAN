...
In addition, the source rate also have a acceptable lower boundary $S_{down}$. When the source rate is lower than the lower boundary $S_{down}$, the vital data will lose the diagnostic significance. Thus, the source rate will be re-configured as the following equation.
\begin{equation}
...
1   & 69 &3.11&35.2&6.1   &	5.4	&  6.1   &  40 & 20\\  \hline
...
As shown in Figure \ref{fig:com_PLR}, the offline scheme has the lowest PLR performance due to the priori knowledge of the channel state.
...
\centering
    \subfigure[Average PLR]{
        \label{fig:com_PLR}
        \includegraphics[width=0.22\textwidth]{com_PLR.eps}
    }
    \hspace{-0.2cm}
    \subfigure[Packet delay]{
        \label{fig:motivation-energy}
        \includegraphics[width=0.22\textwidth]{com_Delay.eps}
    }
		\hspace{-0.2cm}
    \subfigure[Throughput]{
        \label{fig:com_Throughput}
        \includegraphics[width=0.22\textwidth]{com_Throughput.eps}
    }
		\hspace{-0.2cm}
    \subfigure[Energy cost per bit]{
        \label{fig:com_energyPerBit}
        \includegraphics[width=0.22\textwidth]{com_energyPerBit.eps}
    }
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.35\textwidth]{per_EH_efficiency.eps}
...
\centering
\includegraphics[width=0.35\textwidth]{per_EH_efficiency.eps}
\caption{The average QoS performance versus different mean of shadowing.}
\label{fig:ShadowChanges}
\end{figure}

\subsection{The Influence of Coherence Time of EH process on Performance}

\begin{figure}[!htb]
\centering
\includegraphics[width=0.35\textwidth]{per_EH_efficiency.eps}
\caption{The average QoS performance versus different mean of shadowing.}
\label{fig:coherenceTime}
\end{figure}
